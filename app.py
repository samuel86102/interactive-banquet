...
TABLE_DEFINITIONS = [
    ...
    {'id': 'A5', 'name': '音樂', 'group': 'abc'}, {'id': 'B5', 'name': '美術', 'group': 'abc'}, {'id': 'C5', 'name': '美術', 'group': 'abc'}, {'id': 'D5', 'name': '體育', 'group': 'de'}, {'id': 'E5', 'name': '工教', 'group': 'de'}, {'id': 'F5', 'name': '英語', 'group': 'fgi'}, {'id': 'G5', 'name': '英語', 'group': 'fgi'}, {'id': 'H5', 'name': '英語', 'group': 'fgi'}, {'id': 'I5', 'name': '家政', 'group': 'fgi'}, {'id': 'J5', 'name': '公訓、家政', 'group': 'hj'},
    ...
    {'id': 'A3', 'name': '化學', 'group': 'abc'}, {'id': 'B3', 'name': '化學', 'group': 'abc'}, {'id': 'C3', 'name': '化學', 'group': 'abc'}, {'id': 'D3', 'name': '物理、自然科學研究社', 'group': 'de'}, {'id': 'E3', 'name': '54衛教、工教、化學、物理', 'group': 'de'}, {'id': 'F3', 'name': '英語', 'group': 'fgi'}, {'id': 'G3', 'name': '英語', 'group': 'fgi'}, {'id': 'H3', 'name': '教心', 'group': 'hj'}, {'id': 'I3', 'name': '教心', 'group': 'hj'}, {'id': 'J3', 'name': '社教', 'group': 'hj'},
    {'id': 'A2', 'name': '生物', 'group': 'abc'}, {'id': 'B2', 'name': '生物', 'group': 'abc'}, {'id': 'C2', 'name': '數學', 'group': 'abc'}, {'id': 'D2', 'name': '54數學', 'group': 'de'}, {'id': 'E2', 'name': '54數學', 'group': 'de'}, {'id': 'F2', 'name': '54英語、地理', 'group': 'fgi'}, {'id': 'G2', 'name': '地理', 'group': 'fgi'}, {'id': 'H2', 'name': '教育', 'group': 'hj'}, {'id': 'I2', 'name': '教育', 'group': 'hj'}, {'id': 'J2', 'name': '衛教', 'group': 'hj'},
    {'id': 'B1', 'name': '數學', 'group': 'abc'}, {'id': 'C1', 'name': '數學', 'group': 'abc'}, {'id': 'D1', 'name': '54數學', 'group': 'de'},
